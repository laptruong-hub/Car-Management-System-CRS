...
public class DataInitializer {
        ...
        public CommandLineRunner initData() {
                return args -> {
                        ...
                        // Create Fleet Hubs with GPS coordinates
                        log.info("Creating fleet hubs...");
                        FleetHub hub1 = FleetHub.builder()
                                        .name("District 1 Hub")
                                        .location("Ho Chi Minh City, District 1 - Ben Thanh Market area")
                                        .latitude(10.7728) // Ben Thanh Market, District 1
                                        .longitude(106.6980)
                                        .capacity(50)
                                        .currentOccupancy(2) // Will have 2 vehicles
                                        .hasChargingStation(true)
                                        .build();

                        FleetHub hub2 = FleetHub.builder()
                                        .name("District 7 Hub")
                                        .location("Ho Chi Minh City, District 7 - Phu My Hung area")
                                        .latitude(10.7295) // Phu My Hung, District 7
                                        .longitude(106.7212)
                                        .capacity(30)
                                        .currentOccupancy(2) // Will have 2 vehicles
                                        .hasChargingStation(true)
                        ...
                        FleetHub hub3 = FleetHub.builder()
                                        .name("Tan Binh Hub")
                                        .location("Ho Chi Minh City, Tan Binh - Near Tan Son Nhat Airport")
                                        .latitude(10.8167) // Tan Son Nhat Airport area
                                        .longitude(106.6598)
                                        .capacity(40)
                                        .currentOccupancy(1) // Will have 1 vehicle
                        ...
                        log.info("Created {} fleet hubs with GPS coordinates", fleetHubRepository.count());
                        ...
                        // Create Vehicle States with GPS from fleet hubs
                        log.info("Creating vehicle states with hub GPS coordinates...");

                        VehicleState state1 = VehicleState.builder()
                                        .vehicle(vehicle1)
                                        .latitude(hub1.getLatitude()) // GPS from hub
                                        .longitude(hub1.getLongitude())
                                        .batteryLevel(85)
                                        .isCharging(false)
                                        .speedKmh(0.0)
                                        .odometerKm(1250.5)
                        ...
                        VehicleState state2 = VehicleState.builder()
                                        .vehicle(vehicle2)
                                        .latitude(hub1.getLatitude() + 0.005) // Slightly offset for movement
                                        .longitude(hub1.getLongitude() + 0.003)
                                        .batteryLevel(65)
                                        .isCharging(false)
                                        .speedKmh(45.5)
                                        .odometerKm(3456.8)
                        ...
                        VehicleState state3 = VehicleState.builder()
                                        .vehicle(vehicle3)
                                        .latitude(hub2.getLatitude()) // GPS from hub
                                        .longitude(hub2.getLongitude())
                                        .batteryLevel(35)
                                        .isCharging(true)
                                        .speedKmh(0.0)
                                        .odometerKm(567.2)
                        ...
                        VehicleState state5 = VehicleState.builder()
                                        .vehicle(vehicle5)
                                        .latitude(hub3.getLatitude()) // GPS from hub
                                        .longitude(hub3.getLongitude())
                                        .batteryLevel(95)
                                        .isCharging(false)
                                        .speedKmh(0.0)
                                        .odometerKm(234.7)
                        ...
                        log.info("Created {} vehicle states with hub GPS", vehicleStateRepository.count());
